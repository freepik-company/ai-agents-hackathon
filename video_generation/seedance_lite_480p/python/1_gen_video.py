...
API_URL = "https://api.freepik.com/v1/ai/image-to-video/seedance-lite-480p"
...
if response.status_code == 200:
    ...
    while status != "COMPLETED":
        ...
        status_url = f"https://api.freepik.com/v1/ai/image-to-video/seedance-lite-480p/{task_id}"
