...
API_URL = "https://api.freepik.com/v1/ai/image-to-video/pixverse-v5-transition"
...
payload = {
    ...
    "first_image_url": START_FRAME_URL, # Start frame. Only supports URL
    "last_image_url": END_FRAME_URL, # End frame. Only supports URL
    "resolution": "720p", # Possible values: 360p, 540p, 720p, 1080p
    "duration": "5", # Possible values: 5, 8
    "negative_prompt": "ugly, cartoon, b&w, earth, ugly",
    "style": "anime", # Possible values: anime, 3d_animation, clay, cyberpunk, comic 
    "seed": 42,
...
if response.status_code == 200:
    ...
    while status != "COMPLETED":
        ...
        status_url = f"https://api.freepik.com/v1/ai/image-to-video/pixverse-v5/{task_id}"
