...
API_URL = "https://api.freepik.com/v1/ai/image-to-video/minimax-hailuo-02-1080p"
...
if response.status_code == 200:
    ...
    while status != "COMPLETED":
        ...
        status_url = f"https://api.freepik.com/v1/ai/image-to-video/minimax-hailuo-02-1080p/{task_id}"
