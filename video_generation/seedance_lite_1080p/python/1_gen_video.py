...
API_URL = "https://api.freepik.com/v1/ai/image-to-video/seedance-lite-1080p"
...
payload = {
    ...
    "camera_fixed": False, # Whether the camera position should be fixed
    # If an image is provided, the aspect ratio will be inferred from the image
    "aspect_ratio": "square_1_1", # Possible values: film_horizontal_21_9, widescreen_16_9, classic_4_3, square_1_1, traditional_3_4, social_story_9_16, film_vertical_9_21
    "seed": 42,
...
if response.status_code == 200:
    ...
    while status != "COMPLETED":
        ...
        status_url = f"https://api.freepik.com/v1/ai/image-to-video/seedance-lite-1080p/{task_id}"
