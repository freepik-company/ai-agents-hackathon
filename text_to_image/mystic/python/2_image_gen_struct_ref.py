...
STRUCTURE_REFERENCE_URL = "https://img.b2bpic.net/premium-photo/portrait-smiling-senior-woman-blue-vintage-convertible_220770-28364.jpg"
response = requests.get(STRUCTURE_REFERENCE_URL)
if response.status_code == 200:
    print("Structure reference image downloaded successfully")
    STRUCTURE_REFERENCE_B64 = base64.b64encode(response.content).decode("utf-8")
    payload = {
