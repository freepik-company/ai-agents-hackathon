...
# Mystic generation using structure_reference (image provided as base64)
# Requirements:
# - FREEPIK_API_KEY exported or present in .env at project root
# - jq, base64, curl
...
echo "Downloading structure reference image..."
...
echo "Submitting generation request with structure reference..."
