...
payload = {
    ...
    "styling": {
        "style": "anime", # Posssible values photo, digital-art, 3d, painting, low-poly, pixel-art, anime, cyberpunk, comic, vintage, cartoon, vector, studio-shot, dark, sketch, mockup, 2000s-pone, 70s-vibe, watercolor, art-nouveau, origami, surreal, fantasy, traditional-japan
        "effects": {
            ...
            "lightning": "warm", # Possible values: tudio, warm, cinematic, volumetric, golden-hour, long-exposure, cold, iridescent, dramatic, hardlight, redscale, indoor-light
